            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-bold bg-blue-100/10 border-2 border-blue-100/30 text-white hover:bg-blue-100/20 transition-all backdrop-blur-md shadow-lg"
                >
