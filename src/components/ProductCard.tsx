...
export const ProductCard = ({ 
  ...
  const priceColor = isSplitVariant ? "text-white" : "text-blue-600";
  ...
  const badgeClass = isSplitVariant ? "bg-gray-700 text-white" : "bg-blue-50 text-blue-700";
    ...
    return (
      ...
      >
        ...
        <div className={`relative ${mobileImageHeight} overflow-hidden bg-gray-50 flex items-center justify-center p-3`}>
          ...
          <Badge 
            variant="secondary"
            className="absolute top-2 right-2 text-[10px] px-2 py-0.5 bg-gray-800/90 text-white border-0"
          >
      ...
      <div className={cn(mobilePadding, "space-y-4", contentBgColor)}>
        <div className="space-y-2">
          <div className="flex items-start justify-between gap-2">
            <h3 className={cn(
              "font-semibold leading-tight group-hover:text-blue-600 transition-colors line-clamp-1",
              mobileTitleSize,
              titleColor
            )}>
              {product.name}
          ...
          <div className="flex items-center gap-2">
            {showQuickView && (
              <Button
                variant="outline"
                size="sm"
                className="hidden sm:inline-flex text-xs border-gray-300 text-gray-700 hover:bg-gray-50"
                onClick={handleQuickViewClick}
              >
                <Info className="w-3 h-3 mr-1" />
                Details
