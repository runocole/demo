...
// HeroSlider component defined outside of About component
...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full h-full flex items-center">
          <div className="container mx-auto px-6">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-extrabold text-white leading-tight mt-45 tracking-tight">
                About
              </h1>         
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Button
                  ...
                  size="lg"
                  className="bg-blue-900 text-white hover:bg-blue-900 font-bold text-base px-8 py-4 shadow-xl hover:shadow-2xl transition-all mt-0"
                >
                  Contact Us
                </Button>
              </div>
      ...
      <footer className="bg-blue-900 text-white"></footer>
        ...
        <section className="bg-white border-b border-gray-200">
          <div className="container mx-auto px-6 py-4 bg-white">
            ...
            >
              ...
              >
                <Home className="w-4 h-4 bg-white" />
                Home
              </button>
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-6">
            ...
            >
              <div className="text-4xl md:text-5xl lg:text-6xl font-black text-blue-900 mb-6 leading-tight tracking-tight">
        ...
        {/* MISSION STATEMENT WITH LOWERED HEADING */}
        <section className="py-16 bg-white">
          <div className="container mx-auto px-6">
            ...
            >
              {/* LOWERED THIS HEADING */}
              <div className="text-4xl md:text-5xl lg:text-6xl font-black text-blue-900 mb-8 leading-tight tracking-tight pt-12">
                The Leading Geospatial Technology Company
              </div>
              <div className="space-y-6 text-base md:text-lg text-gray-700">
                <p className="font-normal">
              ...
              <div className="text-2xl md:text-3xl font-bold text-blue-900 mt-16 mb-4 tracking-tight">
                Our Mission
              </div>
              <p className="text-base md:text-lg text-gray-700 font-normal mb-12">
          ...
          <div className="container mx-auto px-6 -mt-40">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              ...
              <motion.div
                ...
                className="lg:w-2/5"
              >
                <Card className="bg-white backdrop-blur-sm border-2 border-blue-100 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105">
                  <CardContent className="p-8">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-blue-800">Community Impact</div>
                        <p className="text-blue-600 font-medium">Creating value beyond business</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-blue-900">Education & Training</div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-blue-900">Community Development</div>
                          <p className="text-gray-700 text-sm">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-blue-900">Environmental Care</div>
                          <p className="text-gray-700 text-sm">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            ...
            >
              <div className="text-3xl md:text-4xl font-black text-blue-900 mb-6 tracking-tight">
                Why choose OTIC Geosystems?
              </div>
              <p className="text-base md:text-lg text-gray-700 font-normal mb-12">
                        ...
                        <CardContent className="p-4 md:p-6">
                          ...
                          <div className="flex flex-col items-center text-center md:items-start md:text-left md:flex-row md:gap-4">
                            ...
                            <div className="flex-shrink-0 mb-4 md:mb-0">
                              <div className="w-14 h-14 md:w-12 md:h-12 bg-blue-900-100 rounded-lg flex items-center justify-center mx-auto md:mx-0">
                            ...
                            <div className="flex-1">
                              <div className="text-lg font-bold text-blue-900 mb-2 md:mb-3">
                                {feature.title}
                              </div>
